...
type VisitorUpdate = gen.UpdateVisitorRequestSchema

// VisitorConvert holds the fields for converting a visitor.
type VisitorConvert = gen.ConvertVisitorRequestSchema
...
func (s *VisitorsService) Update(ctx context.Context, update VisitorUpdate) (*Visitor, error) {
	res, err := s.client.generated.UpdateVisitorWithResponse(ctx, nil, gen.UpdateVisitorJSONRequestBody(update))
	if err != nil {
		return nil, err
	}
...
func (s *VisitorsService) Convert(ctx context.Context, req VisitorConvert) (*VisitorConverted, error) {
	res, err := s.client.generated.ConvertVisitorWithResponse(ctx, nil, gen.ConvertVisitorJSONRequestBody(req))
	if err != nil {
		return nil, err
	}
